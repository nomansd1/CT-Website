...
export class FinanceGridComponent {
  tiles =[
    ...
    { url: '../../../../assets/fin18.png', title: '3rd Party Integration' },
    { url: '../../../../assets/fin19.png', title: 'Bank Reconciliation' },
    ...
    { url: '../../../../assets/fin25.png', title: 'Tightly Integrated with Cloud Tenants ERP Module' },
    { url: '../../../../assets/fin26.png', title: 'Real-Time Reporting' },
    { url: '../../../../assets/fin27.png', title: 'Business Intelligence Report & Static Report - MS Power BI Dashboard' },
